...
You can probably tell that we've been super excited about [React Hooks](https://reactjs.org/docs/hooks-intro.html). So when they finally landed in React 16.8, we figured it was time to give our very own `StaticQuery` component the hook treatment!
...
We're really excited about this pattern and everything it enables. With our upcoming [themes](/blog/2019-02-11-gatsby-themes-livestream-and-example/) feature, a theme could even export custom hooks of its own. Users could access data using these without writing a single query.
...
- Check out the [documentation](/docs/use-static-query/)
- To see `useStaticQuery` in action (and for a really gentle introduction to Hooks in general), check out the [livestream](https://www.youtube.com/watch?v=asrdFuAxPaU&list=PLz8Iz-Fnk_eTpvd49Sa77NiF8Uqq5Iykx) Jason Lengstorf and I did last week
- Hit [me](https://twitter.com/chatsidhartha) up on Twitter for any questions!
