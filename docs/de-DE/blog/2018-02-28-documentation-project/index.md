...
- Gatsby is beginner-friendly; however, *true* beginners to programming need an intro to basic tools like the command line, code editors, and browser consoles.
