...
```javascript:title=src/modules/Jumbotron.js import React, { Component } from "react" import { graphql, StaticQuery } from "gatsby"

import "./Jumbotron.css"

export default class Jumbotron extends Component { render() { return ( <section className="jumbotron"> 

# {this.props.item.fields.title}

## {this.props.item.fields.subTitle}</section> ) } } ```
