...
- Additions only likely to be *noticed by* other implementors-of-Gatsby, invisible to users-of-Gatsby.
...
**Gatsby's RFC process owes its inspiration to the [React RFC process](https://github.com/reactjs/rfcs), [Yarn RFC process](https://github.com/yarnpkg/rfcs), [Rust RFC process](https://github.com/rust-lang/rfcs), and [Ember RFC process](https://github.com/emberjs/rfcs)**