...
**NOTE:** If you’ve already had a pull request merged and you have *not* been invited to the maintainers team, please go to [the dashboard](https://store.gatsbyjs.org/) and request a discount code. You should get an invite to the team — *and you get free Gatsby swag!* If that doesn’t work, please email team@gatsbyjs.com and we'll get you invited.
