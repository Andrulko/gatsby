...
This has been a *huge* `TODO` on our list since the very beginning, so we spent a full day thinking through this, writing down our ideas, and discussing what kind of company we want to be.
...
To earn that trust, we need to be deeply committed to always doing the right thing *for the sake of doing the right thing*.
...
**If we say we’re going to do something, we’ll do it.** If we’re going to miss a deadline, we’ll tell you *before* it passes. We’ll show up to meetings on time — and if we’re going to be late, we’ll email or text to let you know.
...
**By taking the time up front to think through our goals and plan appropriately, we will avoid costly mistakes and slowdowns, keep the team and community on the same page, and ultimately move *much faster*** than if we were charging ahead without thinking things through.
...
Are we acting like the company we want to be? Like the *people* we want to be?
