...
You can think of a traditional CMS like an old home built by one person and with custom fittings. Gorgeous, and expensive to maintain, like the home in *The Money Pit* (1986) with Tom Hanks and Shelley Long.
...
<Pullquote citation="Deane Barker"> A headless CMS does nothing but manage content. It doesn’t deliver content to humans at all. Rather, it 'delivers' content to an application of some type. Its immediate consumer is code, and it’s assumed that code will reformat the content for final delivery to a human. </Pullquote>
