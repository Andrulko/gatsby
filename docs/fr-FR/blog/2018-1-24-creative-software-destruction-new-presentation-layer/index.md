...
<Pullquote citation="Winston Churchill"> To improve is to change, so to be perfect is to have changed often. </Pullquote>
...
<Pullquote citation="Elon Musk"> Some people don’t like change, but you need to embrace change if the alternative is disaster. </Pullquote>