...
```js:title=gatsby-config.js module.exports = { proxy: { prefix: "/api", url: "http://dev-mysite.com", }, }

    <br />This way, when you `fetch('/api/todos')` in development, the development server
